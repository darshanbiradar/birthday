    ...
    return (
        ...
        >
            ...
            >
                ...
                <p className="text-lg text-purple-300">The magical moment approaches... now putta</p>
            </motion.div>
            ...
            >
                ...
                <p className="text-purple-300 text-base">The surprise is just moments away💖(Its even saturday the week you were born)</p>
            </motion.div>
        </motion.div>
    )
}
