    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    The countdown is over... Let's celebrate! Putta's Birthday🎉
                </motion.p>
            </motion.div>
            ...
            >
                ...
                >
                    <motion.div className="flex items-center space-x-2" whileTap={{ scale: 0.95 }}>
                        ...
                        <span className="font-semibold">Let's Celebrate bestie!</span>
            ...
            >
                <p className="text-purple-300 text-base">Click to start the magic of putta ji! ✨</p>
            </motion.div>
        </motion.div>
    )
}
